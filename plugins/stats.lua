...
local function run(msg, matches)
  if matches[1]:lower() == 'persian' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "persian" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (persian)",-- Put everything you like :)
		"^[!/]([Pp]ersian)"-- Put everything you like :)
    }, 
  run = run
}
